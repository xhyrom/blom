...
func InterpretCompileTimeFunctionCall(interpreter Interpreter, environment *env.Scope[objects.Object], call *ast.BuiltinFunctionCall) objects.Object {
	return runFunction(interpreter, environment, call)
}

func runFunction(interpreter Interpreter, environment *env.Scope[objects.Object], call *ast.BuiltinFunctionCall) objects.Object {
	switch call.Name {
	case "cast":
...
func cast(interpreter Interpreter, environment *env.Scope[objects.Object], call *ast.BuiltinFunctionCall) objects.Object {
