...
func (s *SourceLocation) ThrowError(msg string, top bool, hints ...*Hint) {
	s.throw("\x1b[31;1mError", msg, top, hints...)
	os.Exit(1)
}

func (s *SourceLocation) ThrowWarning(msg string, top bool, hints ...*Hint) {
	s.throw("\x1b[33;1mWarning", msg, top, hints...)
}

func (s *SourceLocation) throw(prefix string, msg string, top bool, hints ...*Hint) {
	if !top {
	...
	fmt.Fprintf(os.Stderr, " %s\x1b[0m: %s\n", prefix, msgLines[0])
